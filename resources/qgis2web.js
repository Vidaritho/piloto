...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-9059593.101515, -3064738.808256, -5089043.479005, -673479.864161], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-9059593.101515, -3064738.808256, -5089043.479005, -673479.864161], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.className = 'top-left-title ol-control';
         titleElement.innerHTML = '<h1 class="project-title">CENSO AGROPECUARIO</h1> <p class="subtitle"> <b> PRUEBA PILOTO - CARTOGRAFÍA </b></p>';
        return titleElement;
    })(),
 ...
 * @type {string}
 */
var continuePolygonMsg = "1click para continuar, 2click parar";
